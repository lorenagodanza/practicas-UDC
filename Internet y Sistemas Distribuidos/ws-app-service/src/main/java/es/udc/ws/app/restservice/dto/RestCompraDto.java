...
public class RestCompraDto {
    ...
    public RestCompraDto(Long compraId, String emailUsuario, Long partidoId, String ultimosCuatroDigitosTarjeta, int numeroEntradasCompradas, LocalDateTime fechaHoraCompra, boolean entradasRecogidas) {
